class Rfortune < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/umpire274/rFortune/releases/download/v0.2.1/rfortune-x86_64-apple-darwin.tar.gz"
      sha256 "eda8c76ea8a6f9883a523ac2730ba4e0ce12f009ba2cd0489aa3f46b8089a77e"
    elsif Hardware::CPU.arm?
      url "https://github.com/umpire274/rFortune/releases/download/v0.2.1/rfortune-aarch64-apple-darwin.tar.gz"
      sha256 "eac3e22619ffa3a98045cba88f34aa163a1548c8f0bc5b3dfaea83180f243df8"
    end
  end

  on_linux do
    url "https://github.com/umpire274/rFortune/releases/download/v0.2.1/rfortune-x86_64-unknown-linux-gnu.tar.gz"
